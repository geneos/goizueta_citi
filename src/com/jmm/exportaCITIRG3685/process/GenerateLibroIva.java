...
public class GenerateLibroIva extends org.openXpertya.process.GenerateLibroIva {
	...
	protected String doIt() throws java.lang.Exception {
    	...
    	// borro la antigua consulta si la hay
         ...
         sqlReal.append(") inv " +
         	...
         	" 		        from c_invoicetax " +
         	"				where c_tax_id in (select c_tax_id from c_tax where c_taxcategory_id in (select c_taxcategory_id from c_taxcategory where isManual='N'))) cit 	on cit.c_invoice_id = inv.c_invoice_id " +
